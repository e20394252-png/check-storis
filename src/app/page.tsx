      ...
      <div style={s.page} className="animate-fade-in">
        ...
        <div className="approved-banner" style={{ padding: '24px 20px', textAlign: 'center', marginBottom: 20 }}>
          ...
          <div style={{ fontSize: 13, color: 'var(--text-muted)' }}>
            Ты в официальном списке участников
          </div>
        </div>

        {/* Event info */}
        <div style={s.card}>
          <div style={{ fontSize: 10, color: 'var(--neon-cyan)', letterSpacing: '0.1em', marginBottom: 12, opacity: 0.7 }}>
            // МЕРОПРИЯТИЕ
          </div>
      ...
      <div style={s.page} className="animate-fade-in">
        ...
        <div style={{ ...s.card, marginTop: 8 }}>
          <div style={{ fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.6 }}>
            📣 Пока ждёшь — убедись, что твой репост виден в профиле.
            Если хочешь загрузить другой скриншот — нажми кнопку ниже.
          </div>
        </div>

        {/* Allow re-upload in pending state too */}
        <div style={{ marginTop: 16 }}>
          <ReuploadSection
            ...
            label="Загрузить другой скриншот"
          />
        </div>
      </div>
    );
    ...
    return (
      <div style={s.page} className="animate-fade-in">
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <div style={{ ...s.subtitle, marginTop: 6 }}>
            Загрузи новый и мы проверим снова
          </div>
        </div>
        ...
        <ReuploadSection
          ...
          onFileChange={handleFileChange}
          onUpload={handleUpload}
          label="📸 Загрузить новый скриншот"
        />
      </div>
    );
  }
  ...
  return (
    <div style={s.page} className="animate-fade-in">
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        {event.description && (
          <div style={{ ...s.subtitle, marginTop: 8 }}>{event.description}</div>
        )}
      </div>
      ...
      {/* Instructions */}
      <div style={s.card}>
        <div style={{ fontSize: 10, color: 'var(--neon-purple)', letterSpacing: '0.1em', marginBottom: 14, opacity: 0.8 }}>
          // КАК ПОПАСТЬ
        </div>
        {[
      ...
      <ReuploadSection
        ...
        onFileChange={handleFileChange}
        onUpload={handleUpload}
        label="📸 Загрузить скриншот репоста"
      />
...
function ReuploadSection({
  ...
  fileInputRef, onFileChange, onUpload, label,
}: {
