...
export default function AdminPage() {
  ...
  // Не авторизован — вход через Telegram-бота
  if (!organizer) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 24, textAlign: 'center' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: 14, marginBottom: 32, maxWidth: 360 }}>
          Войдите через Telegram-бота для подтверждения личности
        </p>
        ...
        {loginState === 'waiting' && (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
            ...
            <div style={{ fontSize: 12, color: 'var(--text-muted)', maxWidth: 320 }}>
              Перейдите в бот и нажмите <b>Start</b>. Если окно не открылось — <a href="#" onClick={e => { e.preventDefault(); startLogin(); }} style={{ color: 'var(--accent-gold)' }}>попробуйте ещё раз</a>
            </div>
          </div>
        )}
